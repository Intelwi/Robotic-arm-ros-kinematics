...
//------------------------
		...
		pathR.header.frame_id = "/base_link";
//------------------------
...
//------------------------
		pathR.poses.push_back(msg); // ładowanie kolejnego elementu ścieżki
		poseStatePubPath1.publish(pathR); //do wyświetlania śieżki
//------------------------
...
//------------------------
	ros::Publisher poseStatePubPath = n.advertise<nav_msgs::Path>("pathR", 1); //do publikowania ścieżek
